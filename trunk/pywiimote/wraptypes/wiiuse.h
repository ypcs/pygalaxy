...
WIIUSE_EXPORT extern void wiiuse_set_bluetooth_stack(struct wiimote_t** wm, int wiimotes, win_bt_stack_t type);
...
WIIUSE_EXPORT extern void wiiuse_set_ir_position(struct wiimote_t* wm, ir_position_t pos);
WIIUSE_EXPORT extern void wiiuse_set_aspect_ratio(struct wiimote_t* wm, aspect_t aspect);
